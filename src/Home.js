    ...
    return (
        <>
            ...
            <p className="lead font-weight-normal">
                ...
                Каждое исправление бага – это время, потраченное на нахождение, устранение и повторное тестирование.
            </p>
            ...
            <p className="lead font-weight-normal">
                Наличие рейтинговой системы мотивирует не писать многословный, лишний код.
                Мотивирует разбивать сложную логику на несколько простых строк. Равномерная
                сложность кода повышает его читаемость и поддерживаемость.
            </p>
            <br />
            <h2>
            ...
            <p className="lead font-weight-normal">
                ...
                Объективная оценка навыков позволит им быстрее себя проявить через результат работы.
